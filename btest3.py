...
posdict = {variablenames[0]: array([0,5]),
            ...
            variablenames[3]: array([4,2]),
            variablenames[4]: array([8,5]),
            variablenames[5]: array([8,2]),
            variablenames[6]: array([12,3.5]),
            variablenames[7]: array([4,9]),
            variablenames[8]: array([4,0]),
            variablenames[9]: array([8,9]),
            variablenames[10]: array([15,3.5]),
            variablenames[11]: array([8,0])} #position dictionary
...
plt.subplot(313)
nx.draw_networkx(G, pos=posdict)
nx.draw_networkx_edges(G,pos=posdict,width=5.0,edge_color=edgecolorlist, style='solid',alpha=0.2)
nx.draw_networkx_nodes(G,pos=posdict, node_color='y',node_size=900)
plt.axis('off')
...
nx.draw_networkx_edge_labels(H, pos=posdict,edge_labels=weights, style='solid',alpha=0.5, width = 0.5, label_pos= 0.5)
nx.draw_networkx_nodes(G,pos=posdict, node_color='y',node_size=900)
plt.axis("off")
plt.show()
