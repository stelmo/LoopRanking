...
step1 = localgains("connectionsTEfullyconnected.csv", "inputgains45Scaled.txt", 13) #dont forget to update the state-case variable
import numpy as np
localgainmatrix = step1.normaliseGainMatrix(step1.linlocalgainmatrix)
variables = step1.variables
np.savetxt("linearscaledlocalgainsTEfullyconnected.txt", localgainmatrix, delimiter = ",")
